...
---
Baseado na RFC 1510, o  Kerberos fornece autenticação para o ambiente de computação distribuído e padronização para interoperar com diversos sistemas operacionais. Em ambientes Microsoft Windows, o protocolo é instalado como parte do Active Directory Services, oferecendo o controle centralizado de gerenciamento de contas de usuários, serviços, computadores e recursos.
...
![](http://127.0.0.1:4000/images/kb101/01.png)
...
![](http://127.0.0.1:4000/images/kb101/02.png)
...
![](http://127.0.0.1:4000/images/kb101/03.png)

***

* Para que o usuário possa utilizar algum serviço do domínio, o processo de autorização se dá através do envio do TGT ao Domain Controller para a requisição do Service Ticket ou TGS (Ticket-Grating-Service), ex.: MSSqlSvc/SQL.domain.com.

![](http://127.0.0.1:4000/images/kb101/04.png)
...
![](http://127.0.0.1:4000/images/kb101/05.png)
...
![](http://127.0.0.1:4000/images/kb101/06.png)
...
Lista de SPN's: [https://adsecurity.org/?page_id=183](https://adsecurity.org/?page_id=183)
...
Espero ter coragem para escrever sobre como funcionam os ataques nos próximos posts.
